...
const Returns = () => {
    ...
    useEffect(() => {
        ...
        // Listen for return drop OTPs (when rider arrives at Warehouse)
    ...
    const handleApprove = async (orderId) => {
        try {
            await warehouseApi.approveReturn(orderId, {});
    ...
    const handleReject = async () => {
        ...
        try {
            ...
            await warehouseApi.rejectReturn(selectedReturn.orderId, { reason: rejectReason });
    ...
    const handleAssignPickup = async (orderId) => {
        try {
            ...
            await warehouseApi.assignReturnDelivery(orderId, {});
                                    ...
                                    selectedReturn.returnStatus === "return_drop_pending") && selectedReturn.returnDeliveryBoy && (
                                        <div className="bg-brand-50 rounded-2xl p-4 border border-brand-100 space-y-2">
                                            ...
                                            {selectedReturn.returnDeliveryBoy.phone && (
                                                ...
                                                >
                                                    ðŸ“ž {selectedReturn.returnDeliveryBoy.phone}
                                                </a>
                                            )}
