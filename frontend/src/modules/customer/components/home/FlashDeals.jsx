            ...
            <div className="container w-full max-w-[1920px] mx-auto px-4 md:px-[50px] relative z-10">
                <div className="flex flex-col md:flex-row items-center justify-between mb-10 gap-6">
                    <div className="flex items-center gap-6 text-center md:text-left">
                        <div className="h-16 w-16 bg-primary rounded-3xl flex items-center justify-center text-white shadow-xl shadow-primary/20 animate-pulse">
                            <Zap size={32} fill="currentColor" />
                        </div>
                        <div>
                            <div className="flex items-center justify-center md:justify-start gap-2 mb-1">
                                <span className="bg-primary text-white text-[10px] font-black px-2 py-0.5 rounded uppercase tracking-widest">
                                    Limited Time
                                </span>
                                <div className="flex items-center gap-1 text-primary font-bold text-xs uppercase">
